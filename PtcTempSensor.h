...
class PtcTempSensor : public MappedAnalogSensor {
  ...
  /**
    ...
    */
    PtcTempSensor(byte pin, unsigned int maxValue=0, unsigned int minValue=0, byte displayLength=4, byte displayDecimals=1, unsigned int divideBy=1) : MappedAnalogSensor(pin, maxValue, minValue, displayLength, displayDecimals, divideBy) {
